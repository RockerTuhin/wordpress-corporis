...
add_action('init','corporis_starting_page_section');
if(!function_exists('corporis_starting_page_section')):

function corporis_starting_page_section(){
	if(function_exists('kc_add_map')):
		kc_add_map(array(
				'corporis_starting_page'=>array(
...
function corporis_section_starting_page($atts,$content){
  ob_start();
...
<section class="ImageBackground ImageBackground--overlay v-align-parent u-height450 js-Parallax" data-overlay="6" style="position: inherit;">
	<?php
	$img_src = wp_get_attachment_image_src($background_image,'full'); 
	?>
        <div class="ImageBackground__holder" style="">
...
add_shortcode('corporis_starting_page','corporis_section_starting_page');
